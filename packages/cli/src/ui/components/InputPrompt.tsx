  ...
  return (
    <>
      ...
      <Box
        ...
        borderColor={borderColor}
        paddingX={isAlternateBuffer ? 1 : 0}
        width={mainAreaWidth}
        flexDirection="row"
        alignItems="stretch"
        minHeight={1}
      >
        ...
        {!isAlternateBuffer &&
          // Add a 1px spacer with background color to ensure full coverage if needed,
          // or just nothing as requested "remove the border on the rhs".
          // But if we want the background to extend to the edge, the flexGrow above handles it.
          // However, we need to match the structure if there was a right border logic.
          // Previous code had:
          // {!isAlternateBuffer && (
